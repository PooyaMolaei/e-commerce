...
const Navbar = () => {
  ...
  return (
    shouldRender && (
      <>
          <Disclosure as="nav" className="bg-slate-50 fixed w-full drop-shadow-md">
            {({ open }) => (
              <>
                    ...
                    <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                      {!login && (
                        <Link
                          ...
                          className="relative p-1 mx-2 rounded border border-gray-800 hover:bg-gray-800 hover:text-white"
                        >
                          Log In
                        </Link>
                      )}
